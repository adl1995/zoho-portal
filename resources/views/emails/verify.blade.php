...
<head>
    ...
    <title>Zoho Portal - Account Verification</title>
    ...
    <table cellspacing="0" cellpadding="0" border="0" width="100%">
        ...
        <tr>
            <td bgcolor="#FFFFFF" align="center">
                <table width="650px" cellspacing="0" cellpadding="3" class="container">
                    <tr>
                        <td>Thank you for registering on our website. Please verify your account.</td>
                    </tr>
                </table>
            </td>
        </tr>
        <tr>
            <td bgcolor="#FFFFFF" align="center">
                <table width="650px" cellspacing="0" cellpadding="3" class="container">
                    <tr>
                        <td><a href="/account/verify?verificationkey={{ $user->verify_key }}" class="btn btn-primary">Verify</a></td>
                    </tr>
                </table>
            </td>
        </tr>
